...
public class EmployeeParameters {
   final static private String EMPLOYEE_PARAMETERS = "EmployeeParameters.txt";
                                          // Name of the parameter file
   final static private String NL = "\r\n";     // New line for println
   final static private String PERCENT = "%";   // Phrase to display percent
   
   // The employee parameters
